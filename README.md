...
* [Hướng dẫn cài đặt Backend](#huong-dan-cai-dat-backend)
* [Hướng dẫn cài đặt Frontend](#huong-dan-cai-dat-frontend)
* [Cấu hình hệ thống](#cau-hinh-he-thong)

---

## ✨ Tính năng nổi bật <a name="tinh-nang-noi-bat"></a>
...
## 🛠 Công nghệ sử dụng <a name="cong-nghe-su-dung"></a>
...
## 🚀 Hướng dẫn cài đặt
### 1. Cấu hình Backend (.NET API) <a name="huong-dan-cai-dat-backend"></a>

* **Bước 1**: Mở solution `Shoe.sln` bằng Visual Studio.
* **Bước 2**: Cấu hình cơ sở dữ liệu và các Token bảo mật (Xem phần [Cấu hình appsettings.json](#cau-hinh-he-thong) ).
...
### 2. Cấu hình Frontend (Angular) <a name="huong-dan-cai-dat-frontend"></a>
...
## ⚙️ Cấu hình hệ thống <a name="cau-hinh-he-thong"></a>
